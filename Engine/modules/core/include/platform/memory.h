...
CYBER_CORE_EXTERN_C CYBER_CORE_API void* _cyber_malloc(size_t size);
CYBER_CORE_EXTERN_C CYBER_CORE_API void* _cyber_calloc(size_t count, size_t size);
CYBER_CORE_EXTERN_C CYBER_CORE_API void* _cyber_malloc_aligned(size_t size, size_t align);
CYBER_CORE_EXTERN_C CYBER_CORE_API void* _cyber_calloc_aligned(size_t count, size_t size, size_t align);
CYBER_CORE_EXTERN_C CYBER_CORE_API void* _cyber_new_n(size_t count, size_t size);
CYBER_CORE_EXTERN_C CYBER_CORE_API void* _cyber_new_aligned(size_t size, size_t align);
CYBER_CORE_EXTERN_C CYBER_CORE_API void _cyber_free(void* ptr) CYBER_NOEXCEPT;
CYBER_CORE_EXTERN_C CYBER_CORE_API void _cyber_free_aligned(void* ptr, size_t alignment);
CYBER_CORE_EXTERN_C CYBER_CORE_API void* _cyber_realloc(void* ptr, size_t size);
