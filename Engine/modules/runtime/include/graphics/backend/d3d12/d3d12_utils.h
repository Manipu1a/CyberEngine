...
namespace Cyber
{
    ...
    static D3D12_RESOURCE_STATES D3D12Util_TranslateResourceState(GRAPHICS_RESOURCE_STATE state)
    {
        switch(state)
        {
            ...
            case GRAPHICS_RESOURCE_STATE_GENERIC_READ: return D3D12_RESOURCE_STATE_GENERIC_READ;
            ...
            case GRAPHICS_RESOURCE_STATE_INPUT_ATTACHMENT: return D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
