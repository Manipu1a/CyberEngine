...
namespace Cyber
{
    namespace RenderObject
    {
        ...
        struct EmptyDescriptors_D3D12
        {
            ...
            D3D12_CPU_DESCRIPTOR_HANDLE TextureSRV[(uint8_t)TEXTURE_DIMENSION::TEX_DIMENSION_COUNT - 1];
            D3D12_CPU_DESCRIPTOR_HANDLE TextureUAV[(uint8_t)TEXTURE_DIMENSION::TEX_DIMENSION_COUNT - 1];
