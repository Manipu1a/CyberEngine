...
namespace Cyber::Input { class InputManager; }
...
namespace Cyber
{
    ...
    namespace Core
    {
        ...
        public:
            ...
            CYBER_FORCE_INLINE Input::InputManager* get_new_input_manager() const { return m_pNewInputManager; }
        ...
        protected:
            ...
            Input::InputManager* m_pNewInputManager;
