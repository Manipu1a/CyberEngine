...
namespace Cyber
{
    ...
    WindowsApplication::WindowsApplication(const Cyber::WindowDesc& desc)
    {
        initWindow(desc);
    }

    void WindowsApplication::initWindow(const Cyber::WindowDesc& desc)
    {
        SetProcessDPIAware();
    ...
    void WindowsApplication::onUpdate(float deltaTime)
    {
        /*
        MSG msg;
    ...
    void WindowsApplication::onClose()
    {
        
    }

    uint32_t WindowsApplication::getWidth() const
    {
        return mData.mWindowDesc.mWndW;
    }
    uint32_t WindowsApplication::getHeight() const
    {
    ...
    void WindowsApplication::rebuildDisplayMetrics(DisplayMetrics& outMetrics)
    {
