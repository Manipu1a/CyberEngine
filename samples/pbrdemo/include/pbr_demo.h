...
namespace Cyber
{
    ...
    namespace Samples
    {
        ...
        protected:
            ...
            RenderObject::IRenderPipeline* brdf_lut_pipeline = nullptr;
            ...
            RenderObject::ITexture* prefiltered_cube_texture = nullptr;
            RenderObject::ITexture* brdf_lut_texture = nullptr;
